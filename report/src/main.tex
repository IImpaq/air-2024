...
\newline \noindent The mentioned values, complete results as well as other plots can be found in the evaluation folder within the \href{https://github.com/IImpaq/movie-finder/evaluation}{project repository}.
